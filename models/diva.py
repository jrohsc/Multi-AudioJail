...
class DiVAAssistant(VoiceAssistant):
    def __init__(self):
        self.model = AutoModel.from_pretrained("WillHeld/DiVA-llama-3-v0-8b", cache_dir='/work/pi_ahoumansadr_umass_edu/jroh/jroh_umass_edu/.cache/huggingface/hub', trust_remote_code=True)
